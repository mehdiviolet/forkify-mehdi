...
var _recipeView = require("../js/views/recipeView");
var _recipeViewDefault = parcelHelpers.interopDefault(_recipeView);
var _resultView = require("../js/views/resultView");
var _resultViewDefault = parcelHelpers.interopDefault(_resultView);
var _searchBar = require("../js/views/searchBar");
var _searchBarDefault = parcelHelpers.interopDefault(_searchBar);
var _bookmarkView = require("../js/views/bookmarkView");
var _bookmarkViewDefault = parcelHelpers.interopDefault(_bookmarkView);
var _addrecipe = require("../js/views/Addrecipe");
var _addrecipeDefault = parcelHelpers.interopDefault(_addrecipe);
var _paginationView = require("../js/views/paginationView");
...
const controlRecipe = async function() {
    try {
        ...
        // console.log(id);
        (0, _bookmarkViewDefault.default).render(_model.state.bookmarked);
        (0, _resultViewDefault.default).render(_model.getSearchResultPage());
        //load recipe
        await _model.loadReciep(id);
        (0, _recipeViewDefault.default).render(_model.state.recipes);
    } catch (err1) {
        (0, _recipeViewDefault.default).errorMessage();
    }
};
const controlSearchResults = async function() {
    try {
        ...
        const query = (0, _searchBarDefault.default).getQuery();
        ...
        (0, _resultViewDefault.default).errorMessage();
    }
};
...
const controlServings = function(numberOfServings) {
    _model.updateServings(numberOfServings);
    (0, _recipeViewDefault.default).render(_model.state.recipes);
    console.log(_model.state.recipes);
};
const controlBookmark = function() {
    if (!_model.state.recipes.booked) _model.bookmarkRecipe(_model.state.recipes);
    else _model.removeBookmark(_model.state.recipes.id);
...
const controlAddRecipe = async function(newRecipe) {
    try {
        ...
        (0, _recipeViewDefault.default).render(_model.state.recipes);
        (0, _bookmarkViewDefault.default).render(_model.state.bookmarked);
        window.history.pushState(null, "", `#${_model.state.recipes.id}`);
        (0, _addrecipeDefault.default).renderMessage();
        setTimeout(()=>{
            (0, _addrecipeDefault.default).toggleWindow();
            setTimeout(()=>{
                (0, _addrecipeDefault.default).addUploadForm();
            }, 1000);
        }, 2500);
    } catch (err1) {
        (0, _addrecipeDefault.default).errorMessage(err1);
    }
};
const init = function() {
    (0, _recipeViewDefault.default).addHandlerView(controlRecipe);
    ...
    (0, _searchBarDefault.default).addHandlerField(controlSearchResults);
    (0, _paginationViewDefault.default).addHandlerPagination(controlPagination);
    (0, _addrecipeDefault.default).addHandlerAddRecipe(controlAddRecipe);
};
init();

},{"../js/model":"Y4A21","../js/views/recipeView":"l60JC","../js/views/resultView":"f70O5","../js/views/searchBar":"jyEly","../js/views/bookmarkView":"7YaI3","../js/views/Addrecipe":"9Yber","../js/views/paginationView":"6z7bi","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"Y4A21":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
const loadReciep = async function(id) {
    try {
        const data = await (0, _helpers.AJAX)(`https://forkify-api.herokuapp.com/api/v2/recipes/${id}?key=${(0, _config.API_KEY)}`);
        state.recipes = createRecipeObject(data);
        if (state.bookmarked.some((bookmark)=>bookmark.id === id)) state.recipes.booked = true;
...
const loadSearchResult = async function(query) {
    try {
        const data = await (0, _helpers.AJAX)(`https://forkify-api.herokuapp.com/api/v2/recipes?search=${query}&key=${(0, _config.API_KEY)}`);
...
const updateServings = function(newServings) {
    ...
    state.recipes.cookingTime = Math.floor(newServings * state.recipes.cookingTime / state.recipes.servings);
...
const bookmarkRecipe = function(recipe) {
    if (!state.bookmarked.some((bookmark)=>bookmark.id === recipe.id)) state.bookmarked.push(recipe);
...
const API_KEY = `2e8cfb03-9c38-481e-b051-c382788d064a
`;
...
class RecipeView extends (0, _viewDefault.default) {
    ...
    addHandlerServings(handler) {
        this._parentElement.addEventListener("click", function(e) {
            ...
            if (!btn) return;
            const numServ = +btn.dataset.toUpserving;
            numServ > 0 && handler(numServ);
        });
    }
    ...
    _generateMerkup() {
        ...
        <div class="recipe__details">
            ...
            <div class="recipe__info-buttons">
                <button class="btn--tiny btn--update-servings" data-to-upserving="${this._data.servings - 1}">
                <svg>
            ...
            <svg class="">
                <use href="${0, _iconsSvgDefault.default}#icon-bookmark${this._data.booked ? "-fill" : ""}"></use>
            </svg>
            </button>
        </div>
...
},{"./view":"bWlJ9","../../img/icons.svg":"cMpiy","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bWlJ9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
...
class ResultView extends (0, _viewDefault.default) {
    ...
    _generateMerkupPreview(ing) {
        ...
        return `
    <li class="preview">
    <a class="preview__link ${ing.id === id ? "preview__link--active" : ""}" href="#${ing.id}">
...
},{"./view":"bWlJ9","../../img/icons.svg":"cMpiy","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jyEly":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./view");
var _viewDefault = parcelHelpers.interopDefault(_view);
class SearchBar extends (0, _viewDefault.default) {
...
},{"./view":"bWlJ9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7YaI3":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./view");
var _viewDefault = parcelHelpers.interopDefault(_view);
...
},{"./view":"bWlJ9","../../img/icons.svg":"cMpiy","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9Yber":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./view");
var _viewDefault = parcelHelpers.interopDefault(_view);
class AddRecipe extends (0, _viewDefault.default) {
    ...
    _errorMessage = "There is not any recipe with this name!";
    _message = "Your recipe is added right";
...
class PaginationView extends (0, _viewDefault.default) {
    ...
    _generateMerkup() {
      ...
      `;
        //if Last page
        if (currentPage === pages && pages > 1) return `
        <button data-goto=${currentPage - 1} class="btn--inline pagination__btn--prev">
              <svg class="search__icon">
              <use href="${0, _iconsSvgDefault.default}#icon-arrow-left"></use>
              </svg>
...
},{"./view":"bWlJ9","../../img/icons.svg":"cMpiy","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["kYpTN","aenu9"], "aenu9", "parcelRequirea986")
